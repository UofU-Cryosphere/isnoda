...
if [ ! -e ${TCDC_out}/tcdc.MST.${LAST_DAY}.nc ]; then
    ...
    ls ${NET_SOLAR_DIR}/net_dswrf.MST.${LAST_DAY}.nc
    echo ; echo ">>> Proceed to HRRR-MODIS first day runs <<<" ; echo ; echo
fi