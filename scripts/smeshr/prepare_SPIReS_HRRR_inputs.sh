...
# Script Name: prepare_SPIReS_HRRR_inputs.sh
...
# Usage: ./prepare_SPIReS_HRRR_inputs.sh <BASIN_NAME> <WY> <TOPO>
# Example: prepare_SPIReS_HRRR_inputs.sh animas 2022 /full/path/to/topo.nc
# echo "time prepare_SPIReS_HRRR_inputs.sh $BASIN $WY $TOPO 2>&1 | tee prep_${BASIN}_wy${WY}_$(date +%Y%m%d_%H%M).log"
...
ALBEDO_DIR=/uufs/chpc.utah.edu/common/home/skiles-group3/SPIReS_albedo/
NET_SOLAR_DIR=${BASIN_SMESHR_DIR}/net_HRRR_SPIReS/
...
generic_albedo_script=${ISNODA_DIR}scripts/smeshr/SPIReS/SPIReS_albedo_basin.sh
net_solar_script=${ISNODA_DIR}scripts/smeshr/SPIReS/net_dswrf_for_topo_SPIReS.sh
...
albedo_script=${BASIN_SMESHR_DIR}/SPIReS_albedo_basin_${BASIN}.sh
...
#==========================================
#========== Process SPIReS albedo ==========
#==========================================
if $process_albedo ; then
    # Edit SPIReS_albedo_basin.sh
    ...
    # Update variables in SPIReS_albedo_basin.sh
    # Update BASIN
    ...
    echo ; echo " ============== Finished processing SPIReS albedo ============== " ; echo
else
    echo ; echo " ============== Skipping SPIReS albedo processing ============== " ; echo
fi
#==========================================
#========== Prepare net_solar.nc ==========
#==========================================
# Prepare net_solar.nc from SPIReS albedo and HRRR SW
